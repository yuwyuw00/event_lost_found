...
def report_lost():
    if request.method == 'POST':
        ...
        lost_item = Item(name=name, description=description, status='lost', user_id=current_user.id)
...
def report_found():
    if request.method == 'POST':
        name = request.form['name']
        description = request.form['description']
        found_item = Item(name=name, description=description, status='found', user_id=current_user.id)
